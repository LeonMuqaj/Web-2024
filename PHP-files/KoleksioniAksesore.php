...
<body>
    <header>
        ...
        <div class="flex-2">
        <div class="product">
            <img src="../images/AKESORE-KAPELE-U+NK+CLUB+CAP+U+CB+FUT+WSH+L.png" alt="Produkti 4">
            <p><strong>Kapele Unisex </strong></p>
            <p class="price">Çmimi: 35.00€</p>
            <button id="openModal">SHTO NE SHPORTE</button>
        </div>
        <div class="product">
            <img src="../images/AKSESORE-ICON+AIR+FORCE+1+CARD+WALLET.png" alt="Produkti 5">
            <p><strong>Kulete Unisex Nike Air Force 1 - Icon</strong></p>
            <p class="price">Çmimi: 20.00€</p>
            <button id="openModal">SHTO NE SHPORTE</button>
        </div>
        <div class="product">
            <img src="../images/AKESORE-QANTE1-NK+HAYWARD+BKPK-+HBR+CORE+FA24.png" alt="Produkti 6">
    ...
    <div class="flex-2">
        <div class="product">
            <img src="../images/AKSESORE-ICON+AIR+FORCE+1+CARD+WALLET.png" alt="Produkti 4">
            <p><strong>Kulete Unisex Nike Air Force 1</strong></p>
            <p class="price">Çmimi: 20.00€</p>
            <button id="openModal">SHTO NE SHPORTE</button>
        </div>
        <div class="product">
            <img src="../images/AKESORE-SKIMASK-NIKE+PRO+HYPERWARM+HOOD.png" alt="Produkti 5">
            <p><strong>Skimask per Meshkuj Nike</strong></p>
            <p class="price">Çmimi: 40.00€</p>
            <button id="openModal">SHTO NE SHPORTE</button>
        </div>
        <div class="product">
            <img src="../images/AKESORE-SYZE-Nike+Show+X3+Elite.png" alt="Produkti 6">
    ...
    <div class="flex-2">
        <div class="product">
            <img src="../images/AKSESORE-U+NK+PEAK+BEANIE+SC+HOL24+L.png" alt="Produkti 4">
            <p><strong>Trenerka per Femra Jordan PANT SW J WVN PANT</strong></p>
            <p class="price">Çmimi: 75.00€</p>
            <button id="openModal">SHTO NE SHPORTE</button>
        </div>
        <div class="product">
            <img src="../images/NIKE-QORAPA-U+NK+EVRY+PLS+CSH+ANK+3PR+132.png" alt="Produkti 5">
            <p><strong>Qorapa Unisex Nike</strong></p>
            <p class="price">Çmimi: 13.00€</p>
            <button id="openModal">SHTO NE SHPORTE</button>
        </div>
        <div class="product">
            <img src="../images/diorAKSESORE.png" alt="Produkti 6">
    ...
    <div class="flex-2">
        <div class="product">
            <img src="../images/lacostekapeleM.png" alt="Produkti 4">
            <p><strong>Kapele Unisex Lacoste - Classic</strong></p>
            <p class="price">Çmimi: 50.00€</p>
            <button id="openModal">SHTO NE SHPORTE</button>
        </div>
        <div class="product">
            <img src="../images/QanteDIOR.png" alt="Produkti 5">
            <p><strong>Qante Dior per Femra</strong></p>
            <p class="price">Çmimi: 540.00€</p>
            <button id="openModal">SHTO NE SHPORTE</button>
        </div>
        <div class="product">
            <img src="../images/lacosteBaseballkapele.png" alt="Produkti 6">
    ...
    <div class="flex-2">
        <div class="product">
            <img src="../images/KapeleBucketLacoste.png" alt="Produkti 4">
            <p><strong>Kapele Unisex Lacoste - Bucket</strong></p>
            <p class="price">Çmimi: 50.00€</p>
            <button id="openModal">SHTO NE SHPORTE</button>
        </div>
        <div class="product">
            <img src="../images/QanteNIKESH.png" alt="Produkti 5">
            <p><strong>Qante Nike per femije</strong></p>
            <p class="price">Çmimi: 40.00€</p>
            <button id="openModal">SHTO NE SHPORTE</button>
        </div>
        <div class="product">
            <img src="../images/TOPNK+ACADEMY+-+FA22.jpg" alt="Produkti 6">
    ...
    <div class="flex-2">
        <div class="product">
            <img src="../images/DOREZANIKE+STORM-FIT+GG.png" alt="Produkti 4">
            <p><strong>Doreza Nike Storm-Fit</strong></p>
            <p class="price">Çmimi: 45.00€</p>
            <button id="openModal">SHTO NE SHPORTE</button>
        </div>
        <div class="product">
            <img src="../images/niketrisantwistbottle32oz.png" alt="Produkti 5">
            <p><strong>Shishe uji Nike Twist 32OZ</strong></p>
            <p class="price">Çmimi: 20.00€</p>
            <button id="openModal">SHTO NE SHPORTE</button>
        </div>
        <div class="product">
            <img src="../images/TOPBLUENK+ACADEMY+-+TEAM.png" alt="Produkti 6">
    ...
    <div class="flex-2">
        <div class="product">
            <img src="../images/underamourbag.png" alt="Produkti 4">
            <p><strong>Qante Under Armour</strong></p>
            <p class="price">Çmimi: 45.00€</p>
            <button id="openModal">SHTO NE SHPORTE</button>
        </div>
        <div class="product">
            <img src="../images/QantefitnesiUnderArmour.png" alt="Produkti 5">
            <p><strong>Qante fitnesi Under Armour</strong></p>
            <p class="price">Çmimi: 50.00€</p>
            <button id="openModal">SHTO NE SHPORTE</button>
        </div>
        <div class="product">
            <img src="../images/KapeleUA.png" alt="Produkti 6">
